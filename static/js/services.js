...
(function() {
  ...
  angular.module('cocktail.services', []).service('Ingredients', [
    ...
    'ApiService', function(ApiService) {
      ...
      this.getRecipeInfo = function(recipe, callback) {
        return ApiService.searchForRecipe(recipe, callback);
      };
    ...
    '$http', function($http) {
      ...
      this.searchForRecipe = function(name, callback) {
        var url;
      ...
      this.searchForRecipes = function(words, callback) {
        ...
        return GET(url, function(error, data) {
          var recipes;
